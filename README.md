...
## Environments
- Preview: https://main--sausaxen-darkfantansy--aemysites.aem.page/
- Live: https://main--sausaxen-darkfantansy--aemysites.aem.live/
...
1. Open the `sausaxen-darkfantansy` directory in your favorite IDE and start coding :)
